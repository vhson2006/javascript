...
// File upload
cloudinary.uploader.upload('Capture.png', { tags: 'basic_sample' }, function (err, image) {
  console.log();
...
function performTransformations() {
  ...
  console.log("> " + cloudinary.url(
    uploads.couple2.public_id,
    {
      width: 200,
      height: 150, crop: "fill", gravity: "face", radius: 10, effect: "sepia", format: "jpg" }
    )
  );
